        ...
        <>
          <div className='main-container'>
            <div className='main-descrition'>
              ...
              <img src = {Head_img} alt = "head" width = "80%" />
              <div className='mian-des-1'>The deadline to lock in your health subsidy ends on January 15th, so call the hotline if you qualify!</div>
